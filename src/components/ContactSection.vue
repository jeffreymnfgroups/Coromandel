...
const contactDetails = [
  {
    ...
    label: 'hello@coromandelbranding.com',
  },
  {
  ...
  <section class="contact section-hidden" :class="{ 'section-visible': visible }" id="contact" ref="sectionRef">
    <div class="contact__inner container">
      ...
      <div class="contact__info">
        ...
        <!-- WhatsApp direct -->
        <a href="https://wa.me/919876543210" target="_blank" rel="noopener" class="contact__whatsapp">
