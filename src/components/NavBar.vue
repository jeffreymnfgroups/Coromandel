...
<template>
  <header class="nav" :class="{ 'nav--scrolled': scrolled }">
    <div class="nav__inner container">
      ...
      <!-- Logo -->
      <a href="#hero" class="nav__logo" @click.prevent="scrollToSection('#hero')">
        Corom<span class="nav__logo-accent">a</span>ndel
      </a>
      ...
      <!-- Desktop CTA -->
      <a href="#contact" class="nav__cta" @click.prevent="scrollToSection('#contact')">
        Book Free Demo
      </a>
    ...
    <div class="nav__mobile" :class="{ 'nav__mobile--open': menuOpen }" :aria-hidden="!menuOpen">
      <nav class="nav__mobile-links">
        ...
        <a href="#contact" class="nav__cta nav__cta--mobile" @click.prevent="scrollToSection('#contact')">
          Book Free Demo
        </a>
      </nav>
    </div>
