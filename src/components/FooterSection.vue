    ...
    <div class="footer__body container">
      ...
      <div class="footer__col">
        ...
        <ul class="footer__links footer__contact-links">
          <li>
            <a href="mailto:coromandelbranding@gmail.com" class="footer__link">
              coromandelbranding@gmail.com
            </a>
          </li>
          <li>
            <a href="tel:+918248920182" class="footer__link">
              +91 82489 20182
            </a>
          </li>
          <li>
        ...
        <!-- WhatsApp -->
        <a href="https://wa.me/918248920182" target="_blank" rel="noopener" class="footer__whatsapp" aria-label="WhatsApp">
